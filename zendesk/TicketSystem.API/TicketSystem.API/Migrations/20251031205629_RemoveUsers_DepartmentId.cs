...
{
    /// <inheritdoc />
    public partial class RemoveUsers_DepartmentId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanManageUsers = table.Column<bool>(type: "bit", nullable: true, defaultValue: true),
                    CanManageSystem = table.Column<bool>(type: "bit", nullable: true, defaultValue: true),
                    CanViewReports = table.Column<bool>(type: "bit", nullable: true, defaultValue: true),
                    CanManageDepartments = table.Column<bool>(type: "bit", nullable: true, defaultValue: true),
                    ...
                    TotalAssignedTickets = table.Column<int>(type: "int", nullable: true),
                    TotalResolvedTickets = table.Column<int>(type: "int", nullable: true),
                    AverageResolutionTimeHours = table.Column<double>(type: "float", nullable: true),
                    DepartmentId = table.Column<int>(type: "int", nullable: true),
                    Department = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TotalTickets = table.Column<int>(type: "int", nullable: true),
                    LastTicketDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
